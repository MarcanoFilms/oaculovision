...
from oraculovision.analysis.script_parser import (
    MAX_PUSHDATA_SIZE,
    decode_coinbase_tag,
    is_signaling_bip110,
)
...
def analyze_block(block: dict[str, Any]) -> BlockAnalysis:
    from oraculovision.analysis.spam_score import classify_status, compute_spam_score
    ...
    status = classify_status(spam_score, violation_count, violation_weight, weight or 1)
...
# Ensure built-in detectors are registered on first analysis import.
